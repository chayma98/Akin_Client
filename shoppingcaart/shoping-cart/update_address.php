						...
						<div class="space30"></div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<input class="form-control" name='fname' placeholder="" value="<?php if(isset($row['prenom_client'])) { echo $row['prenom_client']; } ?>" type="text">
								</div>
								<div class="col-md-6">
									<label>Last Name </label>
									<input class="form-control" name='lname' placeholder="" value="<?php if(isset($row['nom_client'])) {echo $row['nom_client']; } ?>" type="text">
								</div>
							</div>
							<div class="clearfix space20"></div>
