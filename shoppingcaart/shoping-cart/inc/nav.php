...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <!-- Brand -->
  <!-- <a class="navbar-brand" href="/hielo-772466825/index.html">akin</a> -->
  ...
  <ul class="navbar-nav ml-auto">
	  ...
	  <?php
                  ...
                  $result2 = mysqli_query($conn, $sql2);
                      ...
                      while($row2 = mysqli_fetch_assoc($result2)) {
                          ...
                          ?> 
						  <a class="dropdown-item" href="index.php?id=<?php echo $row2["id_categorie"] ?>"><?php echo  $row2["nom_categorie"] ?></a>
	...
	<li class="nav-item dropdown   mt-2">
      ...
      <div class="dropdown-menu">
		...
		<a class="dropdown-item" href="/hielo-772466825/index.html">Home</a>
		<a class="dropdown-item" href="logout.php">Login/Logout</a>
		<a class="dropdown-item" href="/hielo-772466825/contact/formpage.html">Contact us</a>
        ...
        ?>
				    	...
				    	<div class="row cart-detail">
		    				...
		    				<div class="col-lg-8 col-sm-8 col-8 cart-detail-product">
		    					<p><a href="single.php?id=<?php echo $row['id_article']?>"><?php echo $row['nom_article']?></a></p>
		    					<span class="price text-info"> $ <?php echo $row['prix']?>.00</span> 
						...
						<div class="row total-header-section">
			      			...
			      			<div class="col-lg-6 col-sm-6 col-6 total-section text-right">
			      				<p>Total: <span class="text-info">$ <?php echo $total ?>.00</span></p>
			      			</div>
				    	</div>
