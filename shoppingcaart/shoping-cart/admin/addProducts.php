...
if(isset($_POST['submit'])){
			...
			if(isset($name) && !empty($name)){
				if(($extension == "jpg" || $extension == "jpeg") && $type == "image/jpeg" && $size<=$max_size){
					...
					if(move_uploaded_file($tmp_name, $location.$name)){
						...
						$sql2 = "INSERT INTO article (nom_article, id_categorie, prix, description, image)
    ...
    $sql = "INSERT INTO article (nom_article, id_categorie, prix, description)     VALUES ('$productname', '$productcategory', '$productprice', '$productdescription' )";
