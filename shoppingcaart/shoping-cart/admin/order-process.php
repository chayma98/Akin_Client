...
if(isset($_POST['submit'])){
    ...
    $up_sql = "UPDATE commande SET etat='$status'  WHERE id_commande=$orderid";
...
<div class="container ">
 ...
 if(isset($_GET['id'])){
     $o_id = $_GET['id'];
				...
				$sql = "SELECT * FROM commande WHERE id_commande='$o_id'";
				$result = mysqli_query($conn, $sql);
